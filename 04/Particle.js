var flowFieldRes = Math.floor(Math.max(window.innerWidth, window.innerHeight)/50);
...
class Particle{
    ...
    update() {
        ...
        // }
        // if(this.pos[1] < this.size || this.pos[1] > height-this.size) {
        //     this.vel[1] *= -1;
        //     this.pos[1] < this.size ? this.pos[1] = this.size : this.pos[1] = height-this.size;
        // }

        this.orientation = Math.atan2(this.vel[1], this.vel[0]) + Math.PI/2;
